...
public class HomePage extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btAppList = (Button) findViewById(R.id.bt_list);
		btAppList.setText(R.string.app_list);
		btAppList.setOnClickListener(this);
	...
	public void onClick(View view) {
		...
		else if (view.equals(btAppList)){
			Intent intent = new Intent(this, ListVewActivity.class);
